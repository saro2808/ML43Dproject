...
\usepackage{setspace}
\setstretch{1.08} % Adds breathing room between lines
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/rgb_and_mask.png}
...
\begin{table}[htbp]
    \centering
    \caption{Performance Comparison of Base and LoRA-tuned Models (Rank-16)}
...
\begin{table}[htbp]
    \centering
    \caption{Evaluation Results for Different Ranks and Learning Rates}
    \label{tab:hyperparam_tuning}
    \small
    \begin{tabularx}{0.8\textwidth}{lllcccc}
        \toprule
        \textbf{Rank} &
        \textbf{LR} &
        \textbf{Scene} &
        ...
        \textbf{Precision} &
        \textbf{Recall} &
        \textbf{Ambiguity rate} \\
        \midrule
         8 & $2\cdot 10^{-4}$ & office4 & 0.82 & 0.75 & 0.92 & 0.00 \\
         8 & $2\cdot 10^{-4}$ & room2   & 0.92 & 0.91 & 0.94 & 0.00 \\
         8 & $2\cdot 10^{-5}$ & office4 & 0.82 & 0.83 & 0.77 & 0.00 \\
         8 & $2\cdot 10^{-5}$ & room2   & 0.89 & 0.92 & 0.87 & 0.00 \\
        \addlinespace
        16 & $2\cdot 10^{-4}$ & office4 & 0.82 & 0.76 & 0.92 & 0.00 \\
        16 & $2\cdot 10^{-4}$ & room2   & 0.92 & 0.91 & 0.94 & 0.00 \\
        \addlinespace
        32 & $2\cdot 10^{-4}$ & office4 & 0.84 & 0.82 & 0.84 & 0.00 \\
        32 & $2\cdot 10^{-4}$ & room2   & 0.91 & 0.90 & 0.93 & 0.00 \\
        \addlinespace
        64 & $2\cdot 10^{-4}$ & office4 & 0.85 & 0.83 & 0.85 & 0.00 \\
        64 & $2\cdot 10^{-4}$ & room2   & 0.92 & 0.93 & 0.91 & 0.00 \\
        64 & $2\cdot 10^{-5}$ & office4 & 0.82 & 0.88 & 0.72 & 0.00 \\
        64 & $2\cdot 10^{-5}$ & room2   & 0.89 & 0.95 & 0.83 & 0.00 \\
        \bottomrule
    \end{tabularx}
\end{table}
