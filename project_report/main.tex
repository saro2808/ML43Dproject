...
highlighting the potential of VLMs for geometry-aware instance association without explicit 3D supervision.
...
limited training data and compute. The key charcteristic of our approach is that it avoids explicit 3D
...
\begin{figure}[htbp]
    ...
    \caption{A negative pair. Assumed difficuly: shape similarity.}
...
\begin{figure}[htbp]
    ...
    \caption{A negative pair. Assumed difficuly: smallness and occlusion.}
...
\begin{figure}[htbp]
    ...
    \caption{A positive pair. Assumed difficuly: symmetry and occlusion.}
